...
RSpec.describe QuestionsController, type: :controller do
  ...
  let (:my_question) do
    Question.create(
      ...
      body: RandomData.random_pharagraph,
      resolved: false
    )
  end
  ...
  describe "PUT update" do
    ...
    it "redirects to the updated question" do
      ...
      expect(reponse).to redirect_to my_question
    end
  end
